...
function playSound() {
  ...
  audioSound.getStatusAsync().then(info => {
    if (!info.isLoaded) {
      ...
      //audioSound.loadAsync({ uri: "https://dictionary.cambridge.org/media/english-chinese-simplified/us_pron/b/ble/blemi/blemish.mp3" }, { shouldPlay: true }, true);

      //audioSound.loadAsync({ uri: "https://dictionary.cambridge.org/media/english-chinese-simplified/us_pron/b/ble/blemi/blemish.mp3" }, { shouldPlay: true }, true);

      audioSound.loadAsync( require('./assets/ussound/abstain.mp3'), { shouldPlay: true }, true);
        ...
        <GestureDetector gesture={pan} >
          <View style={[midStyle]}>
            ...
            <ScrollView
              ...
              <Button title='play' onPress={function () { playSound() }} />
